<template>
  <div class="bookingDiv container">
      ...
      <van-row gutter="5">
        ...
        <van-col span="24">
            <van-field 
              ...
              use-button-slot 
              > 
              <van-button slot="button" size="small" type="primary" @click="getCode" id="authCode" v-if="isShowCode">发送验证码</van-button> 
              <van-button slot="button" size="small" type="primary" @click="getphonenumbe" id="authCode" v-else>{{count}}s</van-button> 
            </van-field>      
        </van-col>
      </van-row>
      <button @click="design" class="bottom">抢0元设计</button>
...
export default {
  data() {
    return {
      ...
      statusBarHeight:0,
      specialId:"",
      freeImg:"http://110.185.161.69:58005/ffff//2a09659c965abf550b7d9ea139b454ee/lADPDgQ9r2nRUGjNAxTNAXc_375_788.jpg"
    }
  },
  computed:{
    imgFormate:function() {
...
<style scoped>
  ...
  .van-button--danger {
    ...
    border: 1px solid #5AA096 !important;
  }
</style>
